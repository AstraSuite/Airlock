...
// Morphing loader ported from caelestia-shell's components/controls/LoadingIndicator.qml.
// Cycles through MaterialShapes with a spring overshoot while rotating slowly.
MaterialShape {
    id: root
